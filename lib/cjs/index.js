...
exports.fromWGS84 = exports.toWGS84 = void 0;
...
class TransformGeoJSON {
    constructor(srs, isForward) {
        ...
        if (isForward) {
            this.func = (coord) => (0, proj4_1.default)(srs).forward(coord);
        }
        else {
            this.func = (coord) => (0, proj4_1.default)(srs).inverse(coord);
        }
    }
}
...
exports.default = TransformGeoJSON;
